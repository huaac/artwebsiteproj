    ...
    <div className='services-container'>
      <div className='art-class-container'>
        ...
        <div className='family-info'>
          <p>Family Discount</p>
          <p>To receive the family discount a full month's tuition must be paid</p>
            <ul>
        ...
        <div className='commitment-info'>
          <p>Commitment Discount</p>
            <p>Cannot be combined with the family discount</p>
              <ul>
      ...
      <div className='camp-container'>
        ...
        <div className='current'>
          ...
          <p>All Summer camps for 2024 have sold out.</p>
          <p>Please look for 2025 summer art camp schedule next February.</p>
        </div>
